...
{
  "$end", "error", "$undefined", "identsym", "numbersym", "\"+\"",
  "\"-\"", "\"*\"", "\"/\"", "\".\"", "\";\"", "\"=\"", "\",\"", "\":=\"",
  "\"const\"", "\"var\"", "\"procedure\"", "\"call\"", "\"begin\"",
  "\"end\"", "\"if\"", "\"then\"", "\"else\"", "\"while\"", "\"do\"",
  "\"read\"", "\"write\"", "\"skip\"", "\"odd\"", "\"<>\"", "\"<\"",
  "\"<=\"", "\">\"", "\">=\"", "\"(\"", "\")\"", "$accept", "program",
  "expr", "skipStmt", YY_NULLPTR
};
#endif
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, char const *file_name)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, char const *file_name)
{
  YYFPRINTF (yyo, "%s %s (",
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yytype, yyvaluep, yylocationp, file_name);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, char const *file_name)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, char const *file_name)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (file_name);
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (file_name, YY_("syntax error"));
#else
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, yylsp, file_name);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[+*yyssp], yyvsp, yylsp, file_name);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
